...
describe('The feed route', () => {  //eslint-disable-line no-undef
    ...
    let app,
        ...
        api, api1, api2, api3, mockResponse1, mockResponse2; //eslint-disable-line no-unused-vars
   ...
   { _id: '5908e508c39885001ba07545',
    ...
    it('returns trending feed', () => { //eslint-disable-line no-undef
        return request(app)
            .get('/feeds/trending')
            .expect(200);
    });

    it('returns individual feed', () => { //eslint-disable-line no-undef
        return request(app)
            .get('/feeds/test1')
            .expect(200);
    });
